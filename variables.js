...
tipo_curso = "plataformas"; //"estandar" "isometrico" "plataformas"
...
coordenadas_mapa = [
    ...
    [-5040, 0],
    [-6300, -0]
]; //// Para curso isométrico;

proporciones_realistas = true; ////Personaje en juego de plataformas;

////Tipo Navegación

con_menunumeros_v2 = false;
...
////Personaje con audio inicial

personaje_audioini = true;
personaje_ini = 1;
y_personajeanima_inicial = 70;
x_personajeanima_inicial_ini = 32;
x_personajeanima_inicial_fin = 182;
...
x_logo_client = 1190;
y_logo_client = 575;
x_logo_client_fin = 1190;
y_logo_client_fin = 575;
scale_logo_client_ini = 0.9;
scale_logo_client_fin = 0.9;
...
if(x_logo_client_fin>1260/2 && y_logo_client_fin>600/2){
    y_instruccionper -= 55;
}

btn_infografia = "2DA6BC" ///Importante debe ir sin #

tipo_iconos = "regular"; //solid, regular, light, thin, duotone;
icono_vineta = "<i class='fa-" + tipo_iconos + " fa-square'></i>";
...
icono_volver = "<i class='fa-" + tipo_iconos + " fa-rotate-left'></i>"
icono_bombillo = "<i class='fa-" + tipo_iconos + " fa-lightbulb'></i>"
icono_ini_instruc = "";
icono_fin_instruc = "";

icono_trofeo = "<i class='fa-" + tipo_iconos + " fa-square-dashed'></i>"
icono_trofeo_on = "<i class='fa-" + tipo_iconos + " fa-square-check'></i>"

icono_tecla_sig = "<i class='fa-"+ tipo_iconos +" fa-caret-right'></i>"
icono_tecla_arriba = "<i class='fa-"+ tipo_iconos +" fa-caret-up'></i>"
...
x_ceja_derecha_per1 = 51;
y_ceja_derecha_per1 = 38;

x_ceja_izquierda_per1 = 25;
y_ceja_izquierda_per1 = 38;
...
x_contenedor_rostro_per1 = 78;
y_contenedor_rostro_per1 = 72;
...
x_contenedor_rostro2_per1 = 100;
y_contenedor_rostro2_per1 = 75;
...
if(x_logo_client_fin>1260/2 && y_logo_client_fin>600/2){
    y_contenedor_btnpersonaje_per1 -= 30;
}
...
y_contenedor_audiobtn_per1 = 305;
